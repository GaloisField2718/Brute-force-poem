...
export class Config {
  ...
  static readonly BEAM_WIDTH = parseInt(process.env.BEAM_WIDTH || '1000', 10); // INCREASED for more seeds
  static readonly TOP_K_PER_POSITION = parseInt(process.env.TOP_K_PER_POSITION || '5', 10); // INCREASED for more variety
